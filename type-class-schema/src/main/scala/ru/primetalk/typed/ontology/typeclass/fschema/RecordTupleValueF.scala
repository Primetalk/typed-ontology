...
//    new SchemaValueType
  ...
  inline given headGetter[F[+_] : Functor, Column, ColumnValue, Schema <: Tuple, SchemaValue <: Tuple]: GetterF[F, Column, ColumnValue, SchemaValue] = new GetterF[F, Column, ColumnValue, SchemaValue]:
