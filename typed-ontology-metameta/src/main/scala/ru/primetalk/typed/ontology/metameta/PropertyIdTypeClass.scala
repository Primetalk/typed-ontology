...
/** Тайп-класс, позволяющий использовать какой-то пользовательский тип для представления свойств
  * объекта. Пользовательский тип PropertyId должен указывать на какой-либо онтологический тип.
