...
trait Relation0:
  ...
  sealed trait WithFk:
    ...
    transparent inline def join[R2 <: Relation0](r2: R2) =
      JointSchema
        .join[schema.type, r2.Schema](schema, r2.schema)
        .leftInnerJoin[FK](fk)(values, r2.values)
...
transparent inline def leftInnerJoin2[T1 <: Relation0, T2 <: Relation0, FK <: ForeignKeyId0](
    table1: T1,
    table2: T2,
    inline fk: FK
