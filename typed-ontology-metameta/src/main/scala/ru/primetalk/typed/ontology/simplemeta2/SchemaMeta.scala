...
sealed trait RecordSchema:
  ...
  transparent inline def indexOfProp[P2 <: RecordProperty0, This >: this.type <: RecordSchema](
      p2: P2
  ): IndexOfProp[p2.type]
...
object RecordSchema:
  ...
  transparent inline def indexOfProp[X <: RecordSchema, P <: RecordProperty0](
      schema: X,
      property: P
  ): schema.IndexOfProp[property.type] =
